...
from .processor import SPMTrackDataProcessor, SPMTrackDataProcessorBatchCollator, \
    SPMTrackDataProcessorLoggingHook, SiamFCCroppingParameter
...
def build_SPMTrack_data_processing_components(transform_config: dict, config: dict, build_context: BuildContext,
                                              dtype: torch.dtype):
    ...
    processor = SPMTrackDataProcessor(
        template_siamfc_cropping_parameter,
        search_region_siamfc_cropping_parameter,
    ...
    batch_collator = SPMTrackDataProcessorBatchCollator(dtype, additional_data_collators)
    print('transform config:\n', pretty_format(transform_config))
    return processor, batch_collator, (
        SPMTrackDataProcessorLoggingHook(), *additional_host_data_pipelines)
