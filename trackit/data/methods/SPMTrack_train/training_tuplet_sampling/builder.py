...
def build_training_tuplet_sampler(datasets: Sequence[TrackingDataset], datasets_sampling_weight: np.ndarray,
                                  sequence_picker: RandomAccessiblePerSequenceSampler,
                                  siamese_sampling_config: dict):
    print('training tuplet sampling:\n' + pretty_format(siamese_sampling_config))
    ...
    return SPMTrack_TrainingTupletSampler(datasets, datasets_sampling_weight, sequence_picker,
