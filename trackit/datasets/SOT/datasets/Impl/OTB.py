...
def construct_OTB(constructor: SingleObjectTrackingDatasetConstructor, seed):
    ...
    for sequence_name, sequence_info in sequence_info_list.items():
        ...
        anno_path = os.path.join(root_path, sequence_info['anno_path'])
        try:
            bbox_anno = np.loadtxt(anno_path, delimiter=',', dtype=int)
        except:
            bbox_anno = np.loadtxt(anno_path, delimiter=None, dtype=int)

        sequence_path = os.path.join(root_path, sequence_path)

        assert end_frame - start_frame + 1 == len(bbox_anno)
        ...
        with constructor.new_sequence() as sequence_constructor:
            ...
            for index_of_bbox, bounding_box in enumerate(bbox_anno):
                if index_of_bbox < init_omit:
                    continue

                with sequence_constructor.new_frame() as frame_constructor:
                    image = '{frame:0{nz}}.{ext}'.format(frame=start_frame + index_of_bbox, nz=nz, ext=ext)
                    frame_constructor.set_path(os.path.join(sequence_path, image), sequence_frame_size)
                    frame_constructor.set_bounding_box(bounding_box.tolist())


_sequence_frame_size = {'Basketball': [576, 432], 'Biker': [640, 360], 'Bird1': [720, 400], 'Bird2': [720, 400], 'BlurBody': [640, 480], 'BlurCar1': [640, 480], 'BlurCar2': [640, 480], 'BlurCar3': [640, 480], 'BlurCar4': [640, 480], 'BlurFace': [640, 480], 'BlurOwl': [640, 480], 'Board': [640, 480], 'Bolt': [640, 360], 'Bolt2': [480, 270], 'Box': [640, 480], 'Boy': [640, 480], 'Car1': [320, 240], 'Car2': [320, 240], 'Car24': [320, 240], 'Car4': [360, 240], 'CarDark': [320, 240], 'CarScale': [640, 272], 'ClifBar': [320, 240], 'Coke': [640, 480], 'Couple': [320, 240], 'Coupon': [320, 240], 'Crossing': [360, 240], 'Crowds': [600, 480], 'Dancer': [320, 246], 'Dancer2': [320, 262], 'David': [320, 240], 'David2': [320, 240], 'David3': [640, 480], 'Deer': [704, 400], 'Diving': [400, 224], 'Dog': [352, 240], 'Dog1': [320, 240], 'Doll': [400, 300], 'DragonBaby': [640, 360], 'Dudek': [720, 480], 'FaceOcc1': [352, 288], 'FaceOcc2': [320, 240], 'Fish': [320, 240], 'FleetFace': [720, 480], 'Football': [624, 352], 'Football1': [352, 288], 'Freeman1': [360, 240], 'Freeman3': [360, 240], 'Freeman4': [360, 240], 'Girl': [128, 96], 'Girl2': [640, 480], 'Gym': [426, 234], 'Human2': [480, 640], 'Human3': [480, 640], 'Human4_2': [640, 480], 'Human5': [480, 640], 'Human6': [480, 640], 'Human7': [320, 240], 'Human8': [320, 240], 'Human9': [320, 240], 'Ironman': [720, 304], 'Jogging_1': [352, 288], 'Jogging_2': [352, 288], 'Jump': [416, 234], 'Jumping': [352, 288], 'KiteSurf': [480, 270], 'Lemming': [640, 480], 'Liquor': [640, 480], 'Man': [241, 193], 'Matrix': [800, 336], 'Mhyang': [320, 240], 'MotorRolling': [640, 360], 'MountainBike': [640, 360], 'Panda': [312, 233], 'RedTeam': [352, 240], 'Rubik': [640, 480], 'Shaking': [624, 352], 'Singer1': [624, 352], 'Singer2': [624, 352], 'Skater': [320, 240], 'Skater2': [320, 262], 'Skating1': [640, 360], 'Skating2_1': [640, 352], 'Skating2_2': [640, 352], 'Skiing': [640, 360], 'Soccer': [640, 360], 'Subway': [352, 288], 'Surfer': [480, 360], 'Suv': [320, 240], 'Sylvester': [320, 240], 'Tiger1': [640, 480], 'Tiger2': [640, 480], 'Toy': [320, 240], 'Trans': [640, 332], 'Trellis': [320, 240], 'Twinnings': [320, 240], 'Vase': [320, 240], 'Walking': [768, 576], 'Walking2': [384, 288], 'Woman': [352, 288]}
