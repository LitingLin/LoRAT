...
from trackit.datasets.base.common.constructor import BaseDatasetConstructorGenerator, set_path_, BaseDatasetSequenceConstructorGenerator, BaseDatasetSequenceConstructor, BaseVideoDatasetConstructor
...
class SingleObjectTrackingDatasetFrameConstructor:
    ...
    def set_path(self, path: str, image_size=None):
        assert path is not None and isinstance(path, str), f'invalid path {path}'
