from trackit.datasets.base.common.manipulator import _BaseDatasetManipulator, DatasetObjectManipulatorIterator
...
class VideoDatasetSequenceManipulator:
    ...
    def get_sequence_frame_size(self, allow_estimation = True):
        ...
        from trackit.miscellanies.most_frequent import get_most_frequent_items_from_list
        sizes = []
