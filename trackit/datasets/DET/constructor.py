from trackit.datasets.base.common.constructor import BaseDatasetConstructorGenerator, BaseImageDatasetConstructor, BaseDatasetImageConstructorGenerator, BaseDatasetImageConstructor
...
class DetectionDatasetImageConstructorGenerator(BaseDatasetImageConstructorGenerator):
    def __init__(self, image: dict, root_path: str, category_id_name_map: dict, context):
        super(DetectionDatasetImageConstructorGenerator, self).__init__(image, context)
